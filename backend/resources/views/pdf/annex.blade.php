...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .legal { font-size: 9.5pt; margin-bottom: 8pt; text-align: justify; }
...
<div class="page">
    ...
    <h1>Wzór aneksu do umowy</h1>
    <h2>{{ $data['contractSignature'] }}</h2>

    <p class="legal">
        1. Strony ustalają iż na dzień zawarcia Aneksu, Uczestnik spełnia warunki Promocji opisane w Regulaminie Promocji dostępnym w placówkach EDS.
    </p>
    <p class="legal">
        2. W następstwie warunków opisanych w pkt. 1 Uczestnik otrzymuje zniżkę zgodnie z tabelą na zajęcia regularne które stanowią przedmiot Umowy numer {{ $data['contractSignature'] }}.
    </p>

    <p class="section-label">Wykaz zniżek w poszczególnych miesiącach*:</p>
