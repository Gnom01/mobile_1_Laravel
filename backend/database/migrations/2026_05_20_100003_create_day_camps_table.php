...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('day_camps', function (Blueprint $table) {
            ...
            $table->string('offer_type', 50)->default('day_camp');
            ...
            // Day camp-specific fields (półkolonie)
            $table->string('turnus_name', 255)->default('');
            $table->string('departure_place', 255)->default('');
            $table->json('transport_options')->nullable();
            $table->json('diet_options')->nullable();
            $table->tinyInteger('medical_required')->default(0);
            $table->tinyInteger('guardian_required')->default(0);
            // Sync fields
