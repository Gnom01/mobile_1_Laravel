...
class PullUsersTicketsJob implements ShouldQueue
{
    use Queueable;
    ...
    {
        $syncService->sync([
            'resource'       => 'userstickets',
            'endpoint'       => '/CrmToMobileSync/getUsersTicketsMobile',
            'model'          => UsersTicket::class,
            'primaryKey'     => 'usersticketsid',
            'pageSize'       => 1000,
            'responseKey'    => 'body',
